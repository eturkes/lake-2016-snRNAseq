...
packages <- c("conflicted", "DT", "Seurat","BiocFileCache", "biomaRt", "dplyr")
...
The data is now sufficiently prepared to form a Seurat object.
We choose not to use a SingleCellExperiement (SCE) object at this time as the data was only released as TPMs, which limit many packages in the SCE ecosystem.
...
```{r}
saveRDS(seurat, file = file.path(results_dir, "data", "seurat.rds"))
